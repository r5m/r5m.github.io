...
define([
	...
	return window.AppData.objBackup = {
		...
		_doSync: function(datastore, flag){
			...
			window.t = this._syncTransactions(datastore, flag);
			return window.t;
        ...
        return declare(null, {
            ...
            putItem: function(obj,dontupload){
                ...
                try{
					...
					//if(!upload)
					if(obj.tags.sort) obj.tags.sort()
					...
					return {id:id, obj: obj, def:idbPromise}
                }catch(e){
